...
const baseRoom: object = { players: '', pending: '', public: false, quorum: 0, capacity: 0, modeId: 0 }
...
const baseRooms: object = { ids: 0 }

export const Rooms = {
  encode(message: Rooms, writer: Writer = Writer.create()): Writer {
...
export const Mode = {
  encode(message: Mode, writer: Writer = Writer.create()): Writer {
    if (message.config !== undefined) {
      Config.encode(message.config, writer.uint32(10).fork()).ldelim()
    }
    if (message.quorum !== 0) {
